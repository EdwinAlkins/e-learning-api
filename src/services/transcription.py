...
class TranscriptionService:
    ...
    def transcribe(self, video_path: Path, word_timestamps: bool = False) -> dict:
        """
    ...
    def _convert_video_to_audio(self, video_path: Path, audio_path: str) -> str:
        ...
        ffmpeg.input(str(video_path)).output(
            audio_path, ar="16000", ac="1", loglevel="quiet"
    ...
    def get_transcription(self, video_path: Path) -> str:
        ...
        with open(
            self.get_transcription_file_path(video_path), "r", encoding="utf-8"
        ) as f:
            return f.read()
